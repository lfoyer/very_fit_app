...
class Activity(models.Model):
    ...
    #user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='tracker_activities')  # Unique related_name
...
class FitnessGoal(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='tracker_fitnessgoals')
